...
import 'package:letsgo/rides.dart';
import 'package:swipebuttonflutter/swipebuttonflutter.dart';

class NeedRide extends StatefulWidget {
  const NeedRide({super.key});

  @override
  State<NeedRide> createState() => _NeedRideState();
}

class _NeedRideState extends State<NeedRide> {
  final timeList = [
    '7:00 to 8:00',
    '8:00 to 9:00',
    '9:00 to 10:00',
        ...
        child: SwipingButton(
          ...
          onSwipeCallback: () async {
            if (startValue == null || toValue == null || timeValue == null) {
              ...
              await firestore
                  .collection('rides')
                  .where('start', isEqualTo: startValue)
